...
const ketNFTAddress = '0xC3a7736b284cE163c45D92b75da4d4A34847be63'
...
describe('ExchangeNft', function() {
  beforeEach(async () => {
    ...
    ketNFT = erc721Factory.attach(ketNFTAddress)
  })
  ...
  it('readyToSellToken', async function() {
    const approveTx = await ketNFT.approve(exchangeNftAddress, 33)
